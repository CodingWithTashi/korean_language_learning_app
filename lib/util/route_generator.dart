...
import 'package:korean_language_learning_app/presentation/home.dart';
import 'package:korean_language_learning_app/presentation/language_type_page.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case PracticeListPage.routeName:
        return MaterialPageRoute(
          builder: (_) => PracticeListPage(),
        );
      ...
      case PracticeMenuPage.routeName:
        return MaterialPageRoute(
          builder: (_) => const PracticeMenuPage(),
        );
      default:
        return _errorRoute();
    }
